...
def main():
    ...
    spark = SparkSession.builder \
        .appName("IcebergTableFragmentationCreation") \
    ...
    target_table = "local.experiment.lineitem_fragmented"
    ...
    if not schemas_match:
        ...
        print(f"Source schema: {source_df.schema}", file=sys.stderr)
        print(f"Fragmented schema: {fragmented_df.schema}", file=sys.stderr)
        spark.stop()
        sys.exit(1)
    ...
    print("Logical equivalence validation PASSED.")
    spark.stop()
